...
describe('Stack', () => {
    ...
    it('renders a button to submit the form', () => {
        expect(stackForm.find('Button').at(1).text()).toEqual('Save and Add the Stack');
    });
    ...
    describe('when adding a new card', () => {
        ...
        // reset cards array to zero after each test
        afterEach(() => {
        ...
        describe('and updating the card prompt',  () => {
            ...
            it('updates prompt in the state', () => {
        ...
        describe('and updating the card answer',  () => {
            ...
            it('updates answer in the state', () => {
